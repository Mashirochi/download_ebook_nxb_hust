...
delete_folder_after_merge = True
...
GA = "_ga=GA1.1.demo"
VISITOR = "visitorId=6cdemo"
ANTIFORGERY = ".AspNetCore.Antiforgery.PAnxZgrQbk8=demo"
AUTH = "auth=jwtdemo"
GA_TRACK = "_ga_HFDYKEJJ3N=demo"
cookie_header = "; ".join([GA, VISITOR, ANTIFORGERY, AUTH, GA_TRACK])

# Cách lấy base_url
# Làm bước 0 như ảnh buoc_0.png rồi xem video
# Ví dụ ở vid là https://reading.nxbbachkhoa.vn/doc-thu/691ef946-4aee-4d96-87bb-b6f9e0c96482/files/thumb/1.jpg?250909172246 thì cậu lấy
# base_url = "https://reading.nxbbachkhoa.vn/doc-thu/691ef946-4aee-4d96-87bb-b6f9e0c96482/files/thumb"
base_url = "https://reading.nxbbachkhoa.vn/doc-sach/502b30d4-bf8e-41c2-a917-78701b9f2847/files/mobile"
id_sach = "231108171815"  # 250909172246
